...
<body>
	<!--
	모든 텍스트 박스 기반의 <input>, <textarea> 그리고 <select> 요소
	.form-control 부여시
	기본적으로 width: 100%; 
	...
	<div class="container">
		<div class="page-header">
			<h1>
				Form Example <small>폼 연습입니다</small>
			</h1>
		</div>
		<h3>기본(Basic) 폼</h3>
		<div class="row">
				...
				<form>
					<div class="form-group col-md-4" style="padding-left: 0">
						...
						<!-- col-md-4:가로폭 조정하는 CLASS는 적용 안됨 
							 가로폭 조정하기 위해서는 DIV에 col-*-* 설정하고
							 padding으로 여백 맞추고
							 <div class="clearfix"></div>추가
							 
						-->
						<input type="email" class="form-control col-md-4 input-lg"
					...
					<div class="form-group">
						...
						<label>파일 업로드</label> <input type="file">
		...
		<!-- 
				...
				레이블과 폼의 하위 요소에 col-*-*을 지정해야 수평폼이 완성된다
				미 지정시 기본폼 배치가 된다
			...
			<div class="col-md-offset-1 col-md-10">
				<form class="form-horizontal">
					<div class="form-group"><!-- <div class="row">와 같다 -->
						<!-- 레이블의 칸수 지정 및  control-label(텍스트 가로 방향 정렬)도 반드시 주자-->
					...
					<div class="form-group">						
						...
						<div class="col-sm-4">							
							<div class="radio">
								...
								<div class="radio disabled" style="display:inline">
									<label><input type="radio" disabled >트랜스 젠더</label>
								</div>
							</div>							
						</div>
					</div>
					...
					<div class="form-group">						
						...
						<div class="col-sm-10" >
							<!-- 중첩 컬럼 사용:즉 textarea가 배치된 행의 영역을 10칸으로 제한 -->
							<div class="row" >
								<div class="col-sm-8" >
					...
					<div class="form-group">
						<div class="col-sm-offset-2 col-sm-10">							
							<div class="checkbox">
								<label> <input type="checkbox"> 아이디 체크
								</label>
							</div>
						</div>
					</div>
